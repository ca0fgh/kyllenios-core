...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/kyllenios-core")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "kyllenios-core")
	...
	viper.SetDefault("database.dbname", "kyllenios-core")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "kyllenios-core:")
...
func GetServerAddress() string {
	...
	v.AddConfigPath("/etc/kyllenios-core")
